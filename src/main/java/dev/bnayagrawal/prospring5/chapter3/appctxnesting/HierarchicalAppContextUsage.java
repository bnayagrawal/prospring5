package dev.bnayagrawal.prospring5.chapter3.appctxnesting;
...
public class HierarchicalAppContextUsage {
    ...
    public static void main(String[] args) {
        ...
        parent.load("classpath:chapter3/appctxnesting/parent-context.xml");
        parent.refresh();

        GenericXmlApplicationContext child = new GenericXmlApplicationContext();
        child.load("classpath:chapter3/appctxnesting/child-context.xml");
